            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4  text-white text-bold py-2">
                        <a href="{{url('/')}}"><img src="public/images/logo.png" height="26px" alt=""></a>
                    </div>
                    <div class="col-md-8">
                        <a href="{{route('cart.show')}}" class="py-2 d-block float-right text-danger">Giỏ hàng<span class="text-success">({{Cart::count()}})</span></a>
                    </div>
                </div>
            </div>
        </div>
